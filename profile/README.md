...
If you're moving off VMware, PCD is designed for you. It supports automated
migration from vSphere, runs on your existing hardware, and exposes standard
OpenStack-compatible APIs that work with Terraform, Ansible, and the rest of
...
Contributions are welcome. See [CONTRIBUTING.md](https://github.com/Platform9-Community/.github/blob/main/CONTRIBUTING.md)
